...
//Entity return functions
	extern DWORD			getEntityBase(int index);											//Get the base address of the entity at provided index
	...
	extern int				getEntAmmo(DWORD playerBase);//Get the position of the desired bone of the entity
}